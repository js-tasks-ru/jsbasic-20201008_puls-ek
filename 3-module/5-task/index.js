...
function getMinMax(str) {
  ...
  // передаем массив с одним элементом - нашей первоначальной строкой, 
  // разбиваем ее на подстроки по первому разделителю, а затем по второму 
  // подстроки помещаем в массив и возвращаем обратно тоже в виде массива
  // затем повторяем вызов для второго разделителя
